...
En pocas palabras, el diseño de este curso está inspirado en lo que ha sido nuestra experiencia personal y lo que hubiesemos deseado que nos enseñaran en la universidad. 
...
Nuestro objetivo es predecir si en el siguiente momento de mercado el precio de Bitcoin subirá o bajará, de tal manra que nos aude a tomar una posición de inversión. Tomamos intervalos de *trading* de seis horas. 
...
Note que primero creamos el objeto *a*, que es un vector de caracteres, y luego lo usamos dentro de la selección. Esto no es un paso necesario, pero ilustra la idea de crear objetos para combinarlos con otros objetos y producir uno nuevo. 
...
Hay muchos algoritmos, es decir formulas, para alcanzar nuestro objetivo. Cuál es el mejor, depende del propósito, los datos qeu tenemos, nuestros recursos computacionales, y el grado de error que podemos tolerar. Usaremos el algoritmo *naive bayes*.
